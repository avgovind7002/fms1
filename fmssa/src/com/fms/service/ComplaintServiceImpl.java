...
public class ComplaintServiceImpl implements ComplaintService {
	...
	public void updateComplaint(int complaintId, String complaint, String roomNumber, String category,String machine,String assignedto, String status, String priority, String comments,String createdDate, String updatedDate){
		
		complaintDao.updateComplaint(complaintId, complaint, roomNumber, category,machine,assignedto, status, priority, comments,createdDate, updatedDate);
	}
